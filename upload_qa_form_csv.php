...
?>                                          
	   ...
	   <form method='post' action='upload_qa_primary_csv.php' enctype='multipart/form-data'>        		
...
?>  
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list mg-t-30">
	   <form method='post' action='upload_qa_Private_csv.php' enctype='multipart/form-data'>        		
...
?> 
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list mg-t-30">
	   <form method='post' action='upload_qa_genaral_csv.php' enctype='multipart/form-data'>        		
