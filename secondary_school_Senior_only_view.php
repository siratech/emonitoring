...
<table  id="data-table-basic" class="table table-striped" style="width:100%">
  ...
  <tr>
	...
	<table  id="data-table-basic" class="table table-striped" style="width:100%">
  <tr>
    <th>Class condition/status (SSS) </th>
  ...
  <tr>
    ...
    <td><table  id="data-table-basic" class="table table-striped" style="width:100%">
        <tr>
 		           ...
 		           <td><?php echo $class_4_acc; ?></td>
				   <td><?php echo $class_5_acc; ?></td>
		           <td><?php echo $class_6_acc; ?></td>				   
  ...
  <tr>
    ...
    <td><table  id="data-table-basic" class="table table-striped" style="width:100%">
        <tr>
 		           ...
 		           <td><?php echo $class_4_agr; ?></td>
				   <td><?php echo $class_5_agr; ?></td>
		           <td><?php echo $class_6_agr; ?></td>				   
  ...
  <tr>
    ...
    <td><table  id="data-table-basic" class="table table-striped" style="width:100%">
        <tr>
 		           ...
 		           <td><?php echo $class_4_bio; ?></td>
				   <td><?php echo $class_5_bio; ?></td>
		           <td><?php echo $class_6_bio; ?></td>				   
  ...
  <tr>
    ...
    <td><table  id="data-table-basic" class="table table-striped" style="width:100%">
        <tr>
 		           ...
 		           <td><?php echo $class_4_chm; ?></td>
				   <td><?php echo $class_5_chm; ?></td>
		           <td><?php echo $class_6_chm; ?></td>				   
  ...
  <tr>
    ...
    <td><table  id="data-table-basic" class="table table-striped" style="width:100%">
        <tr>
 		           ...
 		           <td><?php echo $class_4_com; ?></td>
				   <td><?php echo $class_5_com; ?></td>
		           <td><?php echo $class_6_com; ?></td>				   
  ...
  <tr>
    ...
    <td><table  id="data-table-basic" class="table table-striped" style="width:100%">
        <tr>
 		           ...
 		           <td><?php echo $class_4_eco; ?></td>
				   <td><?php echo $class_5_eco; ?></td>
		           <td><?php echo $class_6_eco; ?></td>				   
  ...
  <tr>
    ...
    <td><table  id="data-table-basic" class="table table-striped" style="width:100%">
        <tr>
 		           ...
 		           <td><?php echo $class_4_geo; ?></td>
				   <td><?php echo $class_5_geo; ?></td>
		           <td><?php echo $class_6_geo; ?></td>				   
  ...
  <tr>
    ...
    <td><table  id="data-table-basic" class="table table-striped" style="width:100%">
        <tr>
 		           ...
 		           <td><?php echo $class_4_phy; ?></td>
				   <td><?php echo $class_5_phy; ?></td>
		           <td><?php echo $class_6_phy; ?></td>				   
   ...
   <tr>
	...
	<table  id="data-table-basic" class="table table-striped" style="width:100%">
  <tr>
    <th>Secondary Seat Status (SSS)</th>
  ...
  <tr>
	...
	<table  id="data-table-basic" class="table table-striped" style="width:100%">
  <tr>
    <th>Monthly Attendance of Students Percentage (SSS)</th>
